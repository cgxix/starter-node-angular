...
function createRemoteTempFolder() {
  return ssh.execCommand(
    'rm -rf my-app-temp && mkdir my-app-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function updateRemoteApp() {
  return ssh.execCommand(
    'cp -r my-app-temp/* my-app/ && rm -rf my-app-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function restartRemoteServices() {
  return ssh.execCommand(
    'cd my-app && sudo service mongod start && pm2 start app.js', {
      cwd: '/home/ubuntu'
  });
}
...
function sshConnect() {
  ...
  ssh
    ...
    .then(function() {
      console.log('Creating `my-app-temp` folder.');
